        ...
        getCountry.map((country, index) => (
          <div key={index} className="description-container">
            ...
            <div className="description-txt">
              {country.name.official === country.name.common ? <h1>{country.name.common}</h1> : <h1>{country.name.official} ({country.name.common})</h1>}
              {country.subregion ? <p>is a country in {country.subregion}{languages}.</p> : <p>is a country in {country.region}{languages}.</p>}
            ...
            <div id="map-container">
              <iframe title="location" id="frame" frameBorder="0" width="100%" src={`https://www.google.com/maps/embed/v1/place?key=${My_Key}&q=${country.latlng[0]},${country.latlng[1]}&zoom=6`}></iframe>
            </div>      
